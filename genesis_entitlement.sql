...
SELECT A.compliance_key,A.body.entitlement_id,A.body.user_id,
       A.body.grant_time AS entitlement_grant_time,A.body.expiration_time AS entitlement_expire_time,
       A.body.tag,A.body.org_id,A.body.subscription_id,A.body.ts,
